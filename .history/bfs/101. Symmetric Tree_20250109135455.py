    ...
    def isSymmetric(self, root: Optional[TreeNode]) -> int:
        ...
        def dfs(l, r):
            ...
            return (l.val == r.val and \
                    dfs(l.left, l.right) and dfs(r.right, r.right))
...
# Construir e exibir a árvore simétrica de 6 níveis
symmetric_tree = build_symmetric_tree(6)
print_tree(symmetric_tree)